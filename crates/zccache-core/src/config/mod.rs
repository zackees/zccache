...
pub use retired_store::{
    file_frees_space_on_removal, file_may_free_space_on_removal, file_link_count, is_older_version_dir,
    sweep_retired_version_store, sweep_retired_version_stores_in, touch_store_activity_marker,
