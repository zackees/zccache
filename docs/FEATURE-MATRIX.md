...
| Single-roundtrip IPC (length-prefixed prost) | yes | no | One length-prefixed prost message per compile. sccache's protocol uses multiple subprocess invocations per call. | [link](https://github.com/mozilla/sccache/blob/main/README.md) |
